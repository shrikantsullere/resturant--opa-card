    ...
    <div className="h-full flex flex-col gap-6">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 shrink-0 print:hidden">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-black tracking-tight text-slate-900 uppercase tracking-wider">Guest Bills</h2>
            <p className="text-slate-600 text-sm font-bold mt-1">Manage guest accounts and room billing</p>
          </div>
        </div>
